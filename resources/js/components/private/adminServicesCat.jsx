...
class AdminServicesCat extends Component{
   constructor(props){
      super(props)
            ...
            <section className="item-add">
               <Form onSubmit={this.handleOnSubmit} encType="multipart/form-data" autoComplete="off">
                  ...
                  <Container className="form-group">
                     ...
                     <span onClick={this.addCategory}><i className="fas fa-plus"></i></span>
                  </Container>
                  {
                     this.state.categorias.map((categoria, index)=>(
                        <Container className="form-group" key={index}>
                           <Input
                              className="form-input"
                              label="Categoria"
                              floatingLabel={true}
                           ...
                           />
                           <span onClick={()=>this.removeCategory(index)}><i className="fas fa-minus"></i></span>
                        </Container>
                     ))
                  }
                  <Container>
...
export default AdminServicesCat