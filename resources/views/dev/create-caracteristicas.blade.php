    ...
    <body>
      <div class="content">
        <div style="padding: 60px 160px 0px 160px" class="container d-flex flex-column ">
              ...
              @endif
              <form action="/dev/caracteristicas/nueva" method="POST" class="form-inline align-items-center justify-content-center" enctype="multipart/form-data">
                  {{ csrf_field() }}
      ...
      <div style="padding: 40px 160px 0px 160px" class="container">
          <p class="text-center">Caracteristicas</p>
          ...
          <ul class="list-group">
            ...
            >
              ...
              <div class="d-flex">
                @if($caracteristica->completado == 0)
                <form action="caracteristicas/editar/{{$caracteristica->id}}" method="POST" class="form-inline align-items-center justify-content-center" enctype="multipart/form-data">
                  {{ csrf_field() }}
                <div class="form-group mx-sm-3 mb-2">
                ...
                @endif
                <form action="caracteristicas/borrar/{{$caracteristica->id}}" method="POST">
                  {{ csrf_field() }}
                  {{ method_field('DELETE') }}
